...
async function createBlueprints(options) {
  ...
  let baseBlueprintOptions = {
    // this used to be this.project.root
    // pkgUp is an assumption and may not be correct 🤷
    target: dirname(await pkgUp()),
    entity,
    // ui: this.ui,
...
export default async function run(commandLineOptions) {
  let options = {
    project: {
      name() {
        return 'wut';
